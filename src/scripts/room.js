...
headers.append("Access-Control-Allow-Headers", 'Origin, X-Requested-With, Content-Type, Accept, Access-Control-Allow-Credentials, Cookie, Set-Cookie, Access-Control-Allow-Methods, Access-Control-Allow-Header, Authorization');
